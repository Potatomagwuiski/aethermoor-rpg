...
export async function execute(message: Message, args: string[]) {
  ...
  const embed = new EmbedBuilder()
    ...
    .addFields(
      ...
      { name: '⚒️ Step 2: Forging Gear', value: 'Use **`rpg mine`**, **`rpg chop`**, or **`rpg harvest`** to gather materials. Then type **`rpg forge bronze_sword`** to craft your first weapon. *Bronze tier equipment is INNATE and does not require a blueprint!*' },
