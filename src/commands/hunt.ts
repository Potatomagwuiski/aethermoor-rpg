...
export async function execute(message: Message) {
  ...
  const COMMON_BPS = [{key: 'blueprint_bronze_sword', name:'Bronze Sword'}, {key:'blueprint_bronze_dagger', name:'Bronze Dagger'}, {key:'blueprint_wood_staff', name:'Wood Staff'}, {key:'blueprint_bone_scythe', name:'Bone Scythe'}, {key:'blueprint_bronze_helmet', name:'Bronze Helmet'}, {key:'blueprint_bronze_chestplate', name:'Bronze Chestplate'}, {key:'blueprint_bronze_boots', name:'Bronze Boots'}, {key:'blueprint_bronze_pickaxe', name:'Bronze Pickaxe'}, {key:'blueprint_bronze_axe', name:'Bronze Axe'}];
